...
@pytest.mark.parametrize(
    ...
    [
        (
            "25.11.2021 14:33:34",
            "M",
            (datetime.datetime(2021, 11, 1, 0, 0), datetime.datetime(2021, 11, 25, 14, 33, 34)),
        ),
        (
            "25.11.2021 14:33:34",
            "ALL",
            (datetime.datetime(2021, 8, 25, 0, 0), datetime.datetime(2021, 11, 25, 14, 33, 34)),
        ),
        (
            "25.01.2021 14:33:34",
            "ALL",
            (datetime.datetime(2020, 10, 25, 0, 0), datetime.datetime(2021, 1, 25, 14, 33, 34)),
        ),
        ("1.1.2022 14:33:34", "W", (datetime.datetime(2021, 12, 27, 0, 0), datetime.datetime(2022, 1, 1, 14, 33, 34))),
        (
            "25.11.2021 14:33:34",
            "Y",
            (datetime.datetime(2021, 1, 1, 0, 0), datetime.datetime(2021, 11, 25, 14, 33, 34)),
        ),
    ],
)
